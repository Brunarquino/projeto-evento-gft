...
public class EventoController {
	...
	@RequestMapping(method = RequestMethod.GET, path = "listarAtividades")
    public ModelAndView listarAtividadesDoDia(@RequestParam Long idDia, Long idEvento) {
        
        ModelAndView mv = new ModelAndView("area-acesso-adm/evento/listar-atividades-de-um-dia.html");
    ...
    @RequestMapping(method = RequestMethod.GET, path = "listarParticipantes")
    public ModelAndView listarParticipantesNoGrupos(@RequestParam Long idGrupo, Long idEvento) {
        ModelAndView mv = new ModelAndView("area-acesso-adm/evento/listar-participantes-de-um-grupo.html");

...
public class PontuacaoPorGrupoService {
	...
	private void conferirBonusPresenca(Long idPontuacaoGrupo) throws Exception {
		...
		int soma = 0;
		int bonusAuxiliar = evento.getListaDeDias().size() * grupo.getListaDeParticipantesDoGrupo().size() * 10;
	...
	private void conferirBonusAtividade(Long idPontuacaoGrupo) throws Exception {
		...
		int soma = 0;
		int bonusAuxiliar = evento.getListaDeDias().size() * grupo.getListaDeParticipantesDoGrupo().size() * (5 * 2);
